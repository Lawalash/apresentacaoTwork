    ...
    <div className="h-full flex flex-col p-10 bg-white text-slate-800">
      ...
      <div className="flex justify-between items-end border-b border-slate-100 pb-4 mb-6">
        ...
        <div className="text-right max-w-md hidden md:block">
           <h3 className="text-lg font-bold text-blue-600">Proposta Comercial – Integração Digital TWork</h3>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 flex-grow">
        ...
        >
          ...
          <div className="bg-slate-900 text-white p-8 rounded-2xl shadow-xl flex-grow flex flex-col justify-center text-center relative overflow-hidden">
            ...
            <div className="bg-white/10 rounded-xl p-4 backdrop-blur-sm">
               <h4 className="text-blue-300 font-bold uppercase text-sm mb-1">Parcelas do projeto</h4>
        ...
        <div className="lg:col-span-7 flex flex-col gap-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
             ...
             >
                <div className="flex justify-between items-start mb-2">
                   <h4 className="font-bold text-slate-800 flex items-center gap-2"><Settings className="w-4 h-4 text-blue-600"/> Taxa de Implantação (35%)</h4>
                </div>
          ...
          <motion.div 
            ...
            className="mt-auto bg-emerald-50 border border-emerald-100 p-5 rounded-xl"
          >
             <h4 className="font-bold text-emerald-800 mb-1">Fluxo simplificado</h4>
             <p className="text-sm text-emerald-700 mb-3">Implantação, integrações e início da cobrança alinhados à data de go-live da operação integrada.</p>
             <div className="flex gap-2">
                <span className="px-2 py-1 bg-white text-emerald-600 text-xs font-bold rounded shadow-sm flex items-center gap-1"><Check size={12}/> Entrega e publicação</span>
                <span className="px-2 py-1 bg-white text-emerald-600 text-xs font-bold rounded shadow-sm flex items-center gap-1"><CreditCard size={12}/> Cobrança após go-live</span>
             </div>
          </motion.div>
