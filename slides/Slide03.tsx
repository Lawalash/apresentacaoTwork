        ...
        <div className="slide03__wrapper">
          ...
          <div className="slide03__content">
            ...
            <div className="slide03__main">
              ...
              Vamos mapear e automatizar o fluxo completo da TK Twork: cadastro de produtos, atualização de estoque e acompanhamento das vendas em todos os canais. A ideia é reduzir atividades manuais, evitar furos de estoque e deixar a operação pronta para escalar.
              </p>
